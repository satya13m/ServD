            ...
            <form onSubmit={handleSubmit} className="mt-4 space-y-6">
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 pr-12 py-2 border border-stone-200 rounded-xl focus:outline-none
              ...
              <div className="bg-orange-50 rounded-xl p-4 border border-orange-100">
                ...
                <div className="flex flex-wrap gap-2">
                  {["Butter Chicken", "Chocolate Brownie", "Caeser Salad"].map(
                    (exmaple) => (
                      <button
                        key={exmaple}
                        type="button"
                        onClick={() => setRecipeName(exmaple)}
