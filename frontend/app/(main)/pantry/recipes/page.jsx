...
import { ArrowLeft, ChefHat,Package, Sparkles ,Loader2, AlertCircle, TrendingUp} from 'lucide-react'
...
const PantryRecipesPage=()=> {
  ...
  //Load suggestions on mount /means Gemini calling
  useEffect(()=>{
      fetchSuggestions();
  },[])
    ...
    <div className="min-h-screen bg-stone-50 pt-24 pb-16 px-4">
      <div className="container mx-auto max-w-6xl">
        <div className="mb-8">
          ...
          {/**Usage stats calling from backend */}
          {recipesData && (
        ...
        {/**Recipes Grid - Using Recipe Card Component */}
        ...
        {/**Rate limit state - if user login is not going on and recipesData is undefined */}
