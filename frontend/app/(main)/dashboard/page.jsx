  ...
  return (
    <div className="min-h-screen bg-stone-50 py-16 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        {/**Recipes of the day- Hero Section */}
        {recipeofTheDay && (
          <section className="mb-24 relative">
            ...
            >
              <div
                className="relative bg-white border-2 border-stone-900 overflow-hidden hover:border-orange-600 hover:shadow-lg
                ...
                <div className="grid md:grid-cols-2 gap-0">
                  ...
                  <div className="p-8 md:p-12 flex flex-col justify-center">
                    <div className="flex flex-wrap gap-2 mb-6">
                      ...
                      <Badge
                        variant="outline"
                        className="border-2 border-stone-600 text-stone-700 bg-stone-50 font-bold"
                      >
