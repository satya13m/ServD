...
//landing page will be server component , so we need user -> for that we need to make it asynvhorounus
    ...
    <div className="min-h-screen bg-stone-50 text-stone-900">
      <section className="pt-32 pb-40 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row items-center gap-20 md:gap-20">
            <div className="flex-1 text-center md:text-left">
              <Badge
                variant="outline"
                className="border-2 border-orange-700 text-orange-700 bg-orange-50 text-sm font-bold
               mb-6 uppercase tracking-wide"
              >
            ...
            {FEATURES.map((feature, i) => {
              ...
              return (
                <Card
                 ...
                 bg-white hover:border-orange-600 hover:shadow-lg transition-all group py-0"
                >
                  <CardContent className="p-8">
                    <div className="flex justify-between items-start mb-6 ">
                      ...
                      <Badge
                        variant="secondary"
                        className="text-stone-500 uppercase text-xs tracking-wider border border-stone-300 font-mono"
                      >
                        {feature.limit}
                      </Badge>
                    </div>
      ...
      <section className="py-12 border-y-2 border-stone-900 bg-stone-900 text-stone-50">
